  ...
  <div class="space-y-8 max-w-6xl mx-auto py-10 px-4">
    ...
    <div class="flex justify-between items-center">
      <div>
        <NuxtLink
          to="/admin"
          class="text-sm font-black text-indigo-500 hover:text-indigo-600 flex items-center gap-1 mb-2"
        >
          ← Back to Sessions
        </NuxtLink>
        <h1
          v-if="session"
          class="text-4xl font-black bg-gradient-to-r from-indigo-500 to-purple-500 bg-clip-text text-transparent"
        >
      ...
      <div v-if="session" class="flex items-center gap-3">
        <span
          ...
          class="px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest border border-current shadow-sm"
        >
          {{ session.status }}
        </span>
      </div>
    ...
    <div v-else-if="session" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <table class="w-full text-left">
              <thead>
                <tr class="bg-white/5 border-b border-white/10">
                  ...
                  <th class="px-6 py-4 font-bold text-sm uppercase text-center">Present</th>
              ...
              <tbody class="divide-y divide-white/5">
                <tr v-for="att in attendances" :key="att.id" class="hover:bg-white/5 transition-colors">
                  ...
                  <td class="px-6 py-4 text-center">
                    <span
                      :class="att.isJoining ? 'text-green-500' : 'text-red-500 opacity-50'"
                  ...
                  <td class="px-6 py-4 text-center">
                    <input
                      ...
                      @change="
                        toggleAttendanceAttr(att.id, 'actualAttended', ($event.target as HTMLInputElement).checked)
                      "
      ...
      <div class="space-y-6">
        <div class="glass-card p-8 sticky top-8">
          <h2 class="text-xl font-bold mb-6 flex items-center gap-2"><span>💰</span> Financial Summary</h2>
          ...
          <div class="space-y-6">
            ...
            <div class="pt-6 border-t border-white/10 space-y-4">
              ...
              <div
                class="flex justify-between items-center p-4 bg-indigo-500/10 rounded-2xl border border-indigo-500/20"
              >
            ...
            <NuxtLink
              ...
              to="/admin"
              class="block w-full py-4 text-center bg-amber-500/10 text-amber-700 border border-amber-500/20 rounded-xl font-bold text-sm"
            >
